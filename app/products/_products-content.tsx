      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl shadow-sm mb-12 border border-pink-100">
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            {(searchQuery || selectedCategory) && (
              <Button
                variant="ghost"
                onClick={() => { setSearchQuery(""); setSortBy("newest"); handleCategoryClick(null) }}
        ...
        {error && !loading && (
          <div className="text-center py-20">
            ...
            <Button onClick={fetchProducts} className="bg-pink-600 hover:bg-pink-700">Try Again</Button>
          </div>
        )}
          ...
          <>
            ...
            {filteredProducts.length === 0 && (
              <div className="text-center py-20">
                ...
                {selectedCategory && (
                  <Button onClick={() => handleCategoryClick(null)} className="bg-pink-600 hover:bg-pink-700">
                    View All Products
                  </Button>
                )}
              </div>
