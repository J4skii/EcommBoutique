...
import { Plus, Package, ShoppingCart, DollarSign, Eye, Edit, Trash2, X, Upload } from "lucide-react"
import Image from "next/image"
import { createProduct, deleteProduct, updateOrderStatus, updateProduct } from "@/app/actions/admin"
...
export default function AdminDashboardClient({ initialProducts, initialOrders, stats }: AdminDashboardClientProps) {
  ...
  const openEditDialog = (product: any) => {
      ...
      // Populate variants if any (logic needed if we fetch variants with products, which we do)
      // For now simple edit
                              ...
                              <DialogContent>
                                  ...
                                  <form action={updateProduct} className="space-y-4">
                                      ...
                                      <div className="grid gap-2">
                                          ...
                                          <Input id="edit-stock" name="stockQuantity" type="number" defaultValue={product.stockQuantity} />
                                      </div>
